...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RangeValidator ID="RangeValidatorRow" runat="server" ControlToValidate="TextBoxRows" ErrorMessage="Please enter a number between 1 and 100" MinimumValue="1" MaximumValue="100" EnableClientScript="False" Font-Bold="False" Type="Integer"></asp:RangeValidator>
    <br />
    ...
    <asp:RangeValidator ID="RangeValidatorColumn" runat="server" ControlToValidate="TextBoxColumns" ErrorMessage="Please enter a number between 1 and 100" MinimumValue="1" MaximumValue="100" EnableClientScript="False" Font-Bold="False" Type="Integer"></asp:RangeValidator>
    <br />
